...
import org.leda.tad.conjuntoDinamico.ConjuntoDinamicoIF;
import org.leda.tad.conjuntoDinamico.ConjuntoVazioException;
import org.leda.tad.conjuntoDinamico.MeuConjuntoDinamico;
...
public class ConjuntoDinamicoTestCase {
	...
	@Test
	public void removerFail2Teste() throws ConjuntoVazioException {
		cd.inserir(4);
		cd.inserir(5);
		cd.inserir(10);
		cd.inserir(8);
	...
	public void predecessorTeste() throws Exception {
		...
		try {
			cd = new MeuConjuntoDinamico(); // Atribuindo a referencia para um novo Conjunto(vazio)
			assertNull(cd.predecessor(83));
			fail("deveria lanar exceo quando chamar minimum num conjunto vazio");
		}catch (Exception e) {}
	}
